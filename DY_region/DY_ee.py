...
#  QCD300toinf_ev = get_mcEventnumber(QCD300toinf_list)
  ...
  filters="DY_region==3 && DY_z_mass>60 && DY_z_mass<120 && (DY_l1_pt>30 || DY_l2_pt>30) && DY_drll>0.3"

  df_DY_tree = ROOT.RDataFrame("Events",DY_list)
  df_DY_tree = df_DY_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_DY_tree = df_DY_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_DY_tree = df_DY_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_WJet_tree = df_WJet_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_WJet_tree = df_WJet_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_WJet_tree = df_WJet_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_WW_tree = df_WW_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_WW_tree = df_WW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_WW_tree = df_WW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_WZ_tree = df_WZ_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_WZ_tree = df_WZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_WZ_tree = df_WZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_ZZ_tree = df_ZZ_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_ZZ_tree = df_ZZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_ZZ_tree = df_ZZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_WWW_tree = df_WWW_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_WWW_tree = df_WWW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_WWW_tree = df_WWW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_WWZ_tree = df_WWZ_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_WWZ_tree = df_WWZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_WWZ_tree = df_WWZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_WZZ_tree = df_WZZ_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_WZZ_tree = df_WZZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_WZZ_tree = df_WZZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_ZZZ_tree = df_ZZZ_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_ZZZ_tree = df_ZZZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_ZZZ_tree = df_ZZZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_tsch_tree = df_tsch_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_tsch_tree = df_tsch_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_tsch_tree = df_tsch_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_t_tch_tree = df_t_tch_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_t_tch_tree = df_t_tch_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_t_tch_tree = df_t_tch_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_tbar_tch_tree = df_tbar_tch_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_tbar_tch_tree = df_tbar_tch_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_tbar_tch_tree = df_tbar_tch_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_tW_tree = df_tW_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_tW_tree = df_tW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_tW_tree = df_tW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_tbarW_tree = df_tbarW_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_tbarW_tree = df_tbarW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_tbarW_tree = df_tbarW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_ttWtoLNu_tree = df_ttWtoLNu_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_ttWtoLNu_tree = df_ttWtoLNu_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_ttWtoLNu_tree = df_ttWtoLNu_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_ttWtoQQ_tree = df_ttWtoQQ_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_ttWtoQQ_tree = df_ttWtoQQ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_ttWtoQQ_tree = df_ttWtoQQ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_ttZ_tree = df_ttZ_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_ttZ_tree = df_ttZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_ttZ_tree = df_ttZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_ttZtoQQ_tree = df_ttZtoQQ_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_ttZtoQQ_tree = df_ttZtoQQ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_ttZtoQQ_tree = df_ttZtoQQ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_ttH_tree = df_ttH_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_ttH_tree = df_ttH_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_ttH_tree = df_ttH_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_ttWW_tree = df_ttWW_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_ttWW_tree = df_ttWW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_ttWW_tree = df_ttWW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_ttWZ_tree = df_ttWZ_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_ttWZ_tree = df_ttWZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_ttWZ_tree = df_ttWZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_ttZZ_tree = df_ttZZ_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_ttZZ_tree = df_ttZZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_ttZZ_tree = df_ttZZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_tzq_tree = df_tzq_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_tzq_tree = df_tzq_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_tzq_tree = df_tzq_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
...
#    df_QCD300toinf_histos.append(df_QCD300toinf_histo)
  ...
  df_TTTo2L_tree = df_TTTo2L_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_TTTo2L_tree = df_TTTo2L_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_TTTo2L_tree = df_TTTo2L_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_TTTo1L_tree = df_TTTo1L_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
  if not add_trigger_SF:
    df_TTTo1L_tree = df_TTTo1L_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*genWeight/abs(genWeight)")
  else:
    df_TTTo1L_tree = df_TTTo1L_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
