...
def trigger(df):
  all_trigger = df.Filter("HLT_Mu17_TrkIsoVVL")
  return all_trigger
...
def Fakerate_Analysis():
  ...
  filters_numerator="n_tight_muon==1 && jet_selection_30 && mt<20 && met<20 && Flag_goodVertices && Flag_globalSuperTightHalo2016Filter && Flag_HBHENoiseFilter && Flag_HBHENoiseIsoFilter && Flag_EcalDeadCellTriggerPrimitiveFilter && Flag_BadPFMuonFilter && Flag_eeBadScFilter && Flag_ecalBadCalibFilter"
  filters_denominator="(n_tight_muon==1 ||n_fakeable_muon==1) && jet_selection_30 && mt<20 && met<20 && Flag_goodVertices && Flag_globalSuperTightHalo2016Filter && Flag_HBHENoiseFilter && Flag_HBHENoiseIsoFilter && Flag_EcalDeadCellTriggerPrimitiveFilter && Flag_BadPFMuonFilter && Flag_eeBadScFilter && Flag_ecalBadCalibFilter"
...
#  ROOT.RDF.RunGraphs({df_ZZG_histo, df_ZZ_histo, df_ggZZ_4e_histo,df_ggZZ_4mu_histo, df_ggZZ_4tau_histo, df_ggZZ_2e2mu_histo,df_ggZZ_2e2tau_histo, df_ggZZ_2mu2tau_histo, df_TTZ_histo,df_TTG_histo, df_WWZ_histo, df_WZG_histo,df_WZZ_histo, df_ZZZ_histo, df_WZTo3L_histo,df_WZTo2L_histo, df_ZG_histo})
  ...
  h_DY_deno.Scale(-1.*lumi*DY_xs/DY_ev)
  h_DY_nume.Scale(-1.*lumi*DY_xs/DY_ev)
