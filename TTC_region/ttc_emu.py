...
#  QCD300toinf_ev = get_mcEventnumber(QCD300toinf_list)
  ...
  filters="ttc_jets && ttc_region==2 && (ttc_l1_pt>30 || ttc_l2_pt>30) && ttc_met>30 && ttc_mll>20 && ttc_drll>0.3 && Flag_goodVertices && Flag_globalSuperTightHalo2016Filter && Flag_HBHENoiseFilter && Flag_HBHENoiseIsoFilter && Flag_EcalDeadCellTriggerPrimitiveFilter && Flag_BadPFMuonFilter && Flag_eeBadScFilter && Flag_ecalBadCalibFilter"
  ...
  df_WJet_tree = df_WJet_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Electron_CutBased_TightID_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_tsch_tree = df_tsch_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Electron_CutBased_TightID_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_t_tch_tree = df_t_tch_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Electron_CutBased_TightID_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_tbar_tch_tree = df_tbar_tch_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Electron_CutBased_TightID_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
...
#  df_QCD50to80_tree = df_QCD50to80_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Electron_CutBased_TightID_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
...
#  df_QCD80to120_tree = df_QCD80to120_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Electron_CutBased_TightID_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
...
#  df_QCD120to170_tree = df_QCD120to170_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Electron_CutBased_TightID_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
...
#  df_QCD170to300_tree = df_QCD170to300_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Electron_CutBased_TightID_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
...
#  df_QCD300toinf_tree = df_QCD300toinf_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Electron_CutBased_TightID_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
...
#    df_QCD300toinf_histos.append(df_QCD300toinf_histo)
  ...
  df_TTTo1L_tree = df_TTTo1L_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Electron_CutBased_TightID_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
