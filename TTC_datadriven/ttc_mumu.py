...
path_fakedata='/eos/cms/store/group/phys_top/ExtraYukawa/'
...
FakeLep_doubleMu_names = ROOT.std.vector('string')()
for f in ["DoubleMuonB.root","DoubleMuonC.root","DoubleMuonD.root","DoubleMuonE.root","DoubleMuonF.root"]:
  FakeLep_doubleMu_names.push_back(path_fakedata+f)

#FakeLep_singleMu_names = ROOT.std.vector('string')()
#for f in ["SingleMuonB.root","SingleMuonC.root","SingleMuonD.root","SingleMuonE.root","SingleMuonF.root"]:
#  FakeLep_singleMu_names.push_back(path_fake+f)
...
def TTC_Analysis():
  ...
  filters="ttc_jets && ttc_region==1 && ttc_l1_pt>30 && ttc_met>30 && ttc_mll>20 && ttc_drll>0.3 && Flag_goodVertices && Flag_globalSuperTightHalo2016Filter && Flag_HBHENoiseFilter && Flag_HBHENoiseIsoFilter && Flag_EcalDeadCellTriggerPrimitiveFilter && Flag_BadPFMuonFilter && Flag_eeBadScFilter && Flag_ecalBadCalibFilter && nGenDressedLepton>1 &&n_bjet_DeepB==0"
  filters_data="ttc_jets && ttc_region==1 && ttc_l1_pt>30 && ttc_met>30 && ttc_mll>20 && ttc_drll>0.3 && Flag_goodVertices && Flag_globalSuperTightHalo2016Filter && Flag_HBHENoiseFilter && Flag_HBHENoiseIsoFilter && Flag_EcalDeadCellTriggerPrimitiveFilter && Flag_BadPFMuonFilter && Flag_eeBadScFilter && Flag_ecalBadCalibFilter &&n_bjet_DeepB==0"
  filters_fake_mc="ttc_jets && ttc_region==1 && ttc_l1_pt>30 && ttc_met>30 && ttc_mll>20 && ttc_drll>0.3 && Flag_goodVertices && Flag_globalSuperTightHalo2016Filter && Flag_HBHENoiseFilter && Flag_HBHENoiseIsoFilter && Flag_EcalDeadCellTriggerPrimitiveFilter && Flag_BadPFMuonFilter && Flag_eeBadScFilter && Flag_ecalBadCalibFilter && lhe_nlepton>1 &&n_bjet_DeepB==0"
  ...
  df_DY_tree = df_DY_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_DY_tree = df_Fake_DY_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_WW_tree = df_WW_tree.Define("trigger_SF","trigger_sf_mm(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_WW_tree = df_WW_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_WW_tree = df_Fake_WW_tree.Define("trigger_SF","trigger_sf_mm(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_WW_tree = df_Fake_WW_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_WZ_tree = df_WZ_tree.Define("trigger_SF","trigger_sf_mm(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_WZ_tree = df_WZ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_WZ_tree = df_Fake_WZ_tree.Define("trigger_SF","trigger_sf_mm(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_WZ_tree = df_Fake_WZ_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_ZZ_tree = df_ZZ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_ZZ_tree = df_Fake_ZZ_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_WWW_tree = df_WWW_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_WWW_tree = df_Fake_WWW_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_WWZ_tree = df_WWZ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_WWZ_tree = df_Fake_WWZ_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_WZZ_tree = df_WZZ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_WZZ_tree = df_Fake_WZZ_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_ZZZ_tree = df_ZZZ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_ZZZ_tree = df_Fake_ZZZ_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_tW_tree = df_tW_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_tW_tree = df_Fake_tW_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_tbarW_tree = df_tbarW_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_tbarW_tree = df_Fake_tbarW_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_ttWtoLNu_tree = df_ttWtoLNu_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_ttWtoLNu_tree = df_Fake_ttWtoLNu_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_ttWtoQQ_tree = df_ttWtoQQ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_ttWtoQQ_tree = df_Fake_ttWtoQQ_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_ttZ_tree = df_ttZ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_ttZ_tree = df_Fake_ttZ_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_ttZtoQQ_tree = df_ttZtoQQ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_ttZtoQQ_tree = df_Fake_ttZtoQQ_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_ttH_tree = df_ttH_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_ttH_tree = df_Fake_ttH_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_ttWW_tree = df_ttWW_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_ttWW_tree = df_Fake_ttWW_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_ttWZ_tree = df_ttWZ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_ttWZ_tree = df_Fake_ttWZ_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_ttZZ_tree = df_ttZZ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_ttZZ_tree = df_Fake_ttZZ_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_tzq_tree = df_tzq_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_tzq_tree = df_Fake_tzq_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_TTTo2L_tree = df_TTTo2L_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_TightID_SF[ttc_l1_id]*Muon_CutBased_TightID_SF[ttc_l2_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l1_id]*Muon_TightRelIso_TightIDandIPCut_SF[ttc_l2_id]*trigger_SF*genWeight/abs(genWeight)")
  ...
  df_Fake_TTTo2L_tree = df_Fake_TTTo2L_tree.Define("fakelep_weight","fakelepweight_mm_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  ...
  df_FakeLep_DoubleMu_tree = ROOT.RDataFrame("Events", FakeLep_doubleMu_names)
  df_FakeLep_DoubleMu_tree = df_FakeLep_DoubleMu_tree.Define("fakelep_weight","fakelepweight_mm_data(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
  df_FakeLep_DoubleMu = df_FakeLep_DoubleMu_tree.Filter(filters_data)
...
#  df_FakeLep_SingleMu_tree = ROOT.RDataFrame("Events", FakeLep_singleMu_names)
#  df_FakeLep_SingleMu_tree = df_FakeLep_SingleMu_tree.Define("fakelep_weight","fakelepweight_mm_data(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,ttc_l1_pt,ttc_l1_eta,ttc_l2_pt,ttc_l2_eta)")
#  df_FakeLep_SingleMu = df_FakeLep_SingleMu_tree.Filter(filters_data)
